...
export class Establecimiento extends Direccion {
  constructor(departamento, municipio, zona, av_calle, nombre_establecimiento, tipo_establecimiento, id_microred){
    ...
    this.tipo_establecimiento=tipo_establecimiento.toUpperCase();

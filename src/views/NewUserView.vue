<template>
      ...
      <fieldset class="form-newuser">
        ...
        <div class="form-content-newuser">
          <label for="">FOTO DE PERFIL</label>
            <img class="img-perfil" v-if="imagenPerfil" :src="imagenPerfil" alt="Imagen seleccionada"/>
  ...
  <!-- <CIcon :icon="cilPlus" class="icon-sidebar" /> -->
        ...
        <div class="form-content-newuser2">
          ...
          <button class="form-btn btn-accept" type="submit"><CIcon :icon="cilCheckAlt" class="icon-newuser"/>CONTINUAR</button>
        </div>
